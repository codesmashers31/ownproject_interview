...
import {
  ...
  MessageSquare, Code as CodeIcon, Settings,
  Users, Share2, MoreVertical, Layout, Clock,
  ChevronLeft, ChevronRight, Copy, MonitorUp, Info
} from 'lucide-react';
    ...
    <div className="flex flex-col h-screen w-full bg-[#202124] text-white overflow-hidden font-sans">
      ...
      <div className="h-20 bg-[#202124] flex items-center justify-between px-6 border-t border-gray-800 z-20">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={handleLeave}
            className="px-6 py-3 rounded-full bg-red-500 hover:bg-red-600 text-white font-medium flex items-center gap-2 transition-all duration-200"
          >
            <PhoneOff size={20} />
